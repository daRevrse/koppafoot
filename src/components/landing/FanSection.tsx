...
const FAN_FEATURES = [
  {
    ...
    description:
      "Consulte les scores en temps réel, découvre les équipes de ta ville et vis chaque match comme si tu y étais.",
  ...
  },
  {
    ...
    description:
      "Découvre les meilleurs joueurs, les équipes qui montent et les statistiques de ta communauté.",
  ...
  },
  {
    ...
    description:
      "Parcours la carte des terrains disponibles autour de toi. Consulte les créneaux, les tarifs et les avis.",
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden rounded-[32px] shadow-xl mb-6">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6">
                    ...
                    {/* Description below */}
                    <p className="text-md text-white text-[#1A1715]/50 leading-relaxed px-1">
                      {feature.description}
                    </p>
                  </div>
                </div>
                ...
                {/* Description below */}
                {/* <p className="text-lg text-justify text-[#1A1715]/50 leading-relaxed px-1">
                  {feature.description}
                </p> */}
              </motion.div>
            );
